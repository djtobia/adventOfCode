...
const requiredFieldsRegexPart1 = [/eyr/g,/iyr/g,/byr/g,/hgt/g,/hcl/g,/ecl/g,/pid/g];
const totalNeeded = 7;
...
const requiredFieldsRegexPart2 = [/\beyr:\d{4}\b/g,/\biyr:\d{4}\b/g, /\bbyr:\d{4}\b/g,/\bhgt:(\d{2}|\d{3})(cm|in)\b/g,/\bhcl:#([0-9a-f]{6})\b/g, /\becl:[a-z]{3}\b/g, /\bpid:\d{9}\b/g];
input.forEach(passport => {
    let fieldCount = 0;
